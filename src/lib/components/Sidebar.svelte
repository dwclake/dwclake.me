...
<section>
	<div
		class="fixed top-0 right-0 z-100 m-[1vh] block size-8 transform rounded-3xl bg-mirage-50 shadow-md transition duration-300 md:hidden dark:bg-mirage-950 dark:shadow-gray-700 {open

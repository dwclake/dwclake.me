	...
	<!-- <div class="p-12 h-full w-full bg-linear-to-br from-light dark:from-dark from-15% dark:from-70% via-[#e2ccea] via-40% dark:via-80% to-dark dark:to-light to-90%"> -->
		<div class="flex jusify-around items-top w-full">
			...
			<div class="flex ml-12">
				<img src={portrait} class="object-fit h-50 md:h-150 lg:h-200 border border-b-32 border-mirage-950 dark:border-mirage-50 rounded-sm shadow-xl transition transform hover:scale-101 duration-300" alt="selife" />
			</div>
		</div>
	<!-- </div> -->
</main>
